...
const initialServices = [
  ...
  { name: "Thuê giày thể thao cao cấp", category: "Thuê dụng cụ", price: 40000, stock: 8, desc: "Giày thể thao êm ái, bám sân cực tốt đầy đủ size.", image: "https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=500&auto=format&fit=crop&q=80" },
  { name: "Hộp bóng/cầu thi đấu", category: "Phụ kiện", price: 230000, stock: 45, desc: "Hộp phụ kiện chuẩn thi đấu câu lạc bộ.", image: "https://images.unsplash.com/photo-1613918108466-292b78a8ef95?w=500&auto=format&fit=crop&q=80" },
